                                ...
                                children: [
                                  ...
                                  Wrap(
                                    ...
                                    children: _availableGoals.map((goal) {
                                      final isSelected = _selectedFiltersMap['Objectif']?.contains(goal) ?? false;
                                      return ChoiceChip(
                                        label: Text(goal),
                                        selected: isSelected,
                                        onSelected: (selected) {
                                          setState(() {
                                            if (selected) {
                                              _selectedFiltersMap['Objectif'] = {goal};
                                            } else {
                                              _selectedFiltersMap['Objectif'] = {};
                                            }
                                        ...
                                        selectedColor: GliftTheme.accent,
                                      );
                                    }).toList(),
                                  ),
                                ],
